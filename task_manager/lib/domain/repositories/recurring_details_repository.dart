...
abstract class RecurringTaskRepository {
  ...
  Future<void> updateCompletedOnDates(int taskId, List<DateTime> completedDates);
  Future<void> updateMissedDates(int taskId, List<DateTime> missedDates);

  /// New Methods
  Future<List<DateTime>> getAllScheduledDates(int taskId);
  Future<void> addCompletedDate(int taskId, DateTime completedDate);
  Future<void> removeScheduledDate(int taskId, DateTime scheduledDate);
}
